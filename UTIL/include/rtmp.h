...
#define BT_CHECK_TIME_INTERVAL 		10 //unit : 100ms, must follow timer interval
#define BT_IDLE_STATE_THRESHOLD 	30
#define BT_DETECT_TIMEOUT 	100
...
#ifdef RTMP_USB_SUPPORT
#define IS_ENABLE_BT_THREE_WIRE_BY_FORCE(_pAd)				((((_pAd)->ulBTConfiguration & 0x00000800) == 0x00000800))
#endif // RTMP_USB_SUPPORT //
...
#ifdef BT_COEXISTENCE_SUPPORT
	RALINK_TIMER_STRUCT     BtCoexistDetectTimer;
#endif // BT_COEXISTENCE_SUPPORT //
...
/*****************************************************************************************/
	...
	// BBP Control
	// ---------------------------
#if defined(MERGE_ARCH_TEAM) || defined(RT3593)
...
#define RFIC_5GHZ		0x02
	...
	BOOLEAN 				bBTCoexistenceOn;
#ifdef DOT11_N_SUPPORT
	BOOLEAN 				bBTPermitRecBaDown;
	BOOLEAN 				bBTPermitMcsDown;
	BOOLEAN 				bBTPermitTxBaSizeDown;
	BOOLEAN 				bBTPermitTxBaDensityDown;
#endif // DOT11_N_SUPPORT //
	BOOLEAN 				bBTPermitTxPowerDown;
	BOOLEAN 				bBTPermitLnaGainDown;
	ULONG					ulBTConfiguration; /* bluetooth configureation */
	ULONG					ulBTActiveCountPastPeriod; /* Record Buletooth activities in the past period */
	BLUETOOTH_BUSY_DEGREE	BTBusyDegree; /* BT Device Status */
#endif // BT_COEXISTENCE_SUPPORT //
};
