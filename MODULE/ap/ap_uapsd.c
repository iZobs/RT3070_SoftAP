	...
	IN	UINT32			bulkEnPos)
{
	...
	for(IdEntry=1; IdEntry<MAX_LEN_OF_MAC_TABLE; IdEntry++)
	{
		...
		{
#ifdef UAPSD_DEBUG
			DBGPRINT(RT_DEBUG_TRACE, ("uapsd> bulkStartPos = %d\n", bulkStartPos));
			DBGPRINT(RT_DEBUG_TRACE, ("uapsd> bulkEnPos = %d\n", bulkEnPos));
			DBGPRINT(RT_DEBUG_TRACE, ("uapsd> record offset = %d\n", pEntry->UAPSDTagOffset[AcQueId]));
#endif // UAPSD_DEBUG //
...
#ifdef UAPSD_DEBUG
					DBGPRINT(RT_DEBUG_TRACE, ("uapsd> [1] close SP (%d)!\n", AcQueId));
#endif // UAPSD_DEBUG //
...
#ifdef UAPSD_DEBUG
				DBGPRINT(RT_DEBUG_TRACE, ("uapsd> enqueue the EOSP frame...\n"));
#endif // UAPSD_DEBUG //
...
#ifdef UAPSD_DEBUG
						DBGPRINT(RT_DEBUG_TRACE, ("uapsd> [2] close SP (%d)!\n", AcQueId));
#endif // UAPSD_DEBUG //
					} /* End of if */
