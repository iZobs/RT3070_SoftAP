	...
	IN  BOOLEAN		bHardReset)
{
	...
	IF_DEV_CONFIG_OPMODE_ON_AP(pAd)
	{
		...
		{
			RTMP_IO_WRITE32(pAd, (USHORT)APMACRegTable[Index].Register, APMACRegTable[Index].Value);
		}
	}
#endif // CONFIG_AP_SUPPORT //
...
//	EDCA_PARM DefaultEdcaParm;
	...
	/* 
		USB Default: 0x00DD = 0x01 + 0x04 + 0x08 + 0x10 + 0x40 + 0x80 + 0x0000
		PCI Default: 0x08DD = 0x01 + 0x04 + 0x08 + 0x10 + 0x40 + 0x80 + 0x0800
		...
		0x0000: default is 2 wire, 0x0400 is 1 wire, 0x0800 is 3 wire for usb or single crystal for pci
	*/
#ifdef RTMP_USB_SUPPORT
	pAd->ulBTConfiguration = 0x00DD;
...
#ifdef RTMP_MAC_USB
EXPORT_SYMBOL(UAPSD_UnTagFrame);
#endif // RTMP_MAC_USB //
#endif // UAPSD_AP_SUPPORT //
